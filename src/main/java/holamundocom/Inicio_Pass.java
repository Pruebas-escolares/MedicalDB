...
//import holamundocom.Menu_principal;
import java.awt.Image;
import java.awt.Toolkit;


public class Inicio_Pass extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\mahak\\Downloads\\logoudv.jpg")); // NOI18N

        btn_entrar.setIcon(new javax.swing.ImageIcon("C:\\Users\\mahak\\Downloads\\iniciar-la-sesion.png")); // NOI18N
    ...
    private void btn_entrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_entrarActionPerformed
        Menu_principal nbmenuprin =new Menu_principal();
        nbmenuprin.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inicio_Pass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Inicio_Pass().setVisible(true);
            }
        });
    }
